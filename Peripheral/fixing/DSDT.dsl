 ...
 *
 * Disassembly of DSDT.aml, Thu Dec 12 15:30:02 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000111B5 (70069)
 *     Revision         0x02
 *     Checksum         0x3C
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    External (_SB_.PCI0.IDE0.PRT2.OFLG, IntObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDA898E18, 0x01D1)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120042))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x17, Local2)
                            And (Local2, 0xFFFF, Local2)
                            Return (Add (0x00080000, Local2))
                        }
                    }
    ...
    Scope (_GPE)
    {
        ...
        Method (_L13, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If (\_SB.PCI0.IDE0.PRT2.OFLG)
            {
                ...
                Store (Local7, \_SB.PCI0.LPCB.GPLK)
                Sleep (0x0320)
                Add (0x80, 0x02, Local0)
                Notify (\_SB.PCI0.IDE0, Local0)
            }
    ...
    Scope (_SB.PCI0.EH02.RHUB.PRT1.PRT2)
    {
